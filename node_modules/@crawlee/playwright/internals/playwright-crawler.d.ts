 ...
 * ```
 */
export declare function createPlaywrightRouter<Context extends PlaywrightCrawlingContext = PlaywrightCrawlingContext>(): import("@crawlee/browser").RouterHandler<Context>;
