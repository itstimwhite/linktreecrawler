 ...
 * ```
 */
export declare function createPuppeteerRouter<Context extends PuppeteerCrawlingContext = PuppeteerCrawlingContext>(): import("@crawlee/browser").RouterHandler<Context>;
