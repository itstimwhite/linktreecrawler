...
async function enqueueLinks(options) {
    ...
    function createFilteredRequests() {
        ...
        if (urlPatternObjects.length === 0) {
            return (0, shared_1.createRequests)(requestOptions, enqueueStrategyPatterns);
        }
        // Generate requests based on the user patterns first
        const generatedRequestsFromUserFilters = (0, shared_1.createRequests)(requestOptions, urlPatternObjects);
