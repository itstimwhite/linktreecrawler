 ...
 */
export declare const ACTOR_BASE_DOCKER_IMAGES: ({
    name: string;
    displayName: string;
    prePull: boolean;
    copyChown?: undefined;
 ...
 */
export declare const ACTOR_BASE_DOCKER_IMAGE_DEFAULT: string;
/**
 ...
 * TODO: Remove this once it's no longer used anywhere.
 */
export declare const ACTOR_LOG_MAX_CHARS: number;
/**
